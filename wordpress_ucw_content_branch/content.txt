  ...
  <div id="volunteer_wizard">
    ...
    <div class="group" id="toplevel">
      <p class="question"><img src="images/pictograms/pictogram-community-50x50.png">I am interested in...</p>
      <ul class="choices">
    ...
    <div class="group" id="advocate">
      <p class="question"><img src="images/pictograms/pictogram-quote-50x50.png">Do you want to tell the world about Ubuntu? You could help:</p>
      <ul class="choices">
    ...
    <div class="group" id="communicate">
      <p class="question"><img src="images/pictograms/pictogram-camera-50x50.png">Do you have a mighty pen? You could help:</p>
      <ul class="choices">
    ...
    <div class="group" id="develop">
      <p class="question"><img src="images/pictograms/pictogram-developer-50x50.png">Do you want to change the world with great software? You could help:</p>
      <ul class="choices">
    ...
    <div class="group" id="quality">
      <p class="question"><img src="images/pictograms/pictogram-dashboard-50x50.png">Do you enjoy finding mistakes and fixing problems? You could help:</p>
      <ul class="choices">
        <li target="https://wiki.ubuntu.com/FoundationsTeam"><h3>Improve the core OS</h3>
          <p class="extra">with the Ubuntu Foundations Team</p>
        </li>
    ...
    <div class="group" id="support">
      <p class="question"><img src="images/pictograms/pictogram-help-50x50.png">Do you like helping people? You could help:</p>
      <ul class="choices">
        <li target="http://ubuntuforums.org/forumdisplay.php?f=100"><h3>Compile tutorials</h3>
          <p class="extra">for the Ubuntu Forums</p>
        </li>
    ...
    <div id="responses">
      <div id="ok"><a href="javascript:"><img src="images/pictograms/pictogram-projects-we-love-25x25.png"><span class="textbutton">Tell me more</span></a></div>

      <div id="next">
        <a href="javascript:"><img src="images/pictograms/pictogram-locations-25x25.png"><span class="textbutton negative">No thanks, try another</span><span class="textbutton negative">Show me something else</span><span class="textbutton negative">Too dull, keep going</span><span class="textbutton negative">Not interested, keep looking</span><span class="textbutton negative">Not a good fit, next please</span><span class="textbutton negative">Next please</span></a>
      </div>

      <div id="back"><a href="javascript:"><img src="images/pictograms/pictogram-delete-25x25.png"><span class="textbutton">I was wrong, take me back</span></a></div>
